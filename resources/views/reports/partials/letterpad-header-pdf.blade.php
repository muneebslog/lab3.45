...
<table class="pdf-letterpad-header" width="100%" cellspacing="0" cellpadding="0" style="margin-bottom: 10px;">
    <tr>
            ...
            <table cellspacing="0" cellpadding="0">
                <tr>
                    <td style="vertical-align: top; padding-right: 4px;">
                        <div style="font-size: 26px; font-weight: 600; color: #1e3a8a; font-family: DejaVu Serif, serif; line-height: 1.1;">
                            Mohsin
                        </div>
                        <div style="font-size: 8px; font-family: DejaVu Serif, serif; margin-top: 2px;">
                            PHC REG # R <span style="font-family: DejaVu Sans, sans-serif;">13048</span>
                        </div>
                    </td>
                    <td style="vertical-align: bottom; padding-bottom: 2px;">
                        <div style="font-size: 11px; font-weight: 600; color: #1e3a8a; font-family: DejaVu Serif, serif; line-height: 1.15;">
                            &nbsp;Clinical
                        </div>
                        <div style="font-size: 11px; font-weight: 600; color: #1e3a8a; font-family: DejaVu Serif, serif; line-height: 1.15;">
                            &nbsp;Laboratory
        ...
        <td style="vertical-align: top; text-align: right; width: 38%;">
            <div style="font-family: DejaVu Serif, serif; font-size: 10px;">Medical Record No:</div>
            @if ($barcodeSrc)
