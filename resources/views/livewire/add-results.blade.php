                ...
                <div class="rounded-lg border border-neutral-200 bg-white shadow-sm shadow-neutral-900/5">
                    ...
                    <div class="flex flex-col gap-3 border-t border-neutral-200 bg-neutral-50/50 px-5 py-4 sm:flex-row sm:items-center sm:justify-end sm:px-8">
                        <button wire:click="save({{ $test->id }})" type="button"
                            ...
                            wire:target="save"
                            class="result-save-btn inline-flex w-full items-center justify-center px-5 py-2.5 text-sm font-semibold tracking-wide text-white transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-900 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60 sm:w-auto bg-neutral-900 hover:bg-neutral-800">
