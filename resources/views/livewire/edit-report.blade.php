<div class="add-results-page min-h-[88vh] bg-white text-neutral-900 antialiased">
    <div class="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8 lg:py-10">
        ...
        <header class="mb-10 border-b border-neutral-200 pb-8">
            ...
            <h1 class="mt-2 font-serif text-3xl font-normal tracking-tight text-neutral-900 sm:text-4xl">Edit results</h1>
            <p class="mt-3 max-w-2xl text-sm leading-relaxed text-neutral-600">
                Update stored values for this test. Flags reflect numeric comparison to the reference interval shown.
            </p>
            ...
            <p class="mt-2 max-w-2xl text-xs leading-relaxed text-neutral-500">
                Press <span class="font-mono text-neutral-700">Enter</span> in a result field to jump to the next field; on the last field, <span class="font-mono text-neutral-700">Enter</span> moves focus to <span class="text-neutral-700">Save changes</span> (you can use Tab if you prefer).
            </p>
        </header>
            ...
            <div class="rounded-lg border border-neutral-200 bg-neutral-50/80 px-5 py-6 sm:px-8">
                <dl class="grid gap-x-10 gap-y-5 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div class="space-y-1">
                        ...
                        <dd class="text-sm font-medium capitalize text-neutral-900">{{ $patient->gender }}</dd>
                    </div>
                    <div class="space-y-1">
        ...
        <section class="mb-6" aria-labelledby="test-heading-{{ $test->id }}">
            <div class="rounded-lg border border-neutral-200 bg-white shadow-sm shadow-neutral-900/5">
                <div class="border-b border-neutral-200 px-5 py-5 sm:px-8 sm:py-6">
                    ...
                    <p class="mt-1 text-xs text-neutral-500">Adjust values as needed, then save.</p>
                </div>
    ...
    <script>
        ...
        function attachRangeIndicator(input) {
        ...
        resultInputs.forEach(input => {
            input.addEventListener('input', function() {
                attachRangeIndicator(input);
            });
        });

        resultInputs.forEach(input => attachRangeIndicator(input));
    </script>
    @script
        <script>
            $wire.on('message', (e) => {
