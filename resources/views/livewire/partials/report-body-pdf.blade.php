...
<table width="100%" cellspacing="0" cellpadding="0"
    ...
    <tr valign="top">
        <td style="width: 42%; padding: 8px 12px 8px 0;">
            <table width="100%" cellspacing="0" cellpadding="2">
                ...
                <tr>
                    ...
                    <td style="font-size: 14px; text-align: right;">{{ $data->patient->receipt_no }}</td>
                </tr>
                <tr>
        ...
        <td style="width: 42%; padding: 8px 0 8px 12px;">
            <table width="100%" cellspacing="0" cellpadding="2">
                <tr>
                    <td style="font-weight: bold; font-size: 14px;">Reffered By</td>
                    <td style="font-size: 14px; text-align: right;">{{ $data->patient->doctor }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="font-size: 14px; text-align: right;">{{ $data->patient->phone }}</td>
                </tr>
                <tr>
...
<div style="width: 100%; max-width: 100%;">
    ...
    @elseif (in_array($data->test->code, $codes['codes']))
        ...
        @elseif ($data->test->code == 2831)
            ...
            @endphp
            <table width="100%" cellspacing="0" cellpadding="4" style="font-size: 14px; margin-bottom: 10px;">
                <tr>
                    <td>Patient Name:</td>
